...
function openProxy(urlToProxy) {
  if (document.getElementById("proxyMethod").options[document.getElementById("proxyMethod").selectedIndex].value == "opennew") {
    window.open(localStorage.getItem("proxyLink") + xor.encode(urlToProxy))
  } else if (document.getElementById("proxyMethod").options[document.getElementById("proxyMethod").selectedIndex].value == "cloak") {
    cloak(localStorage.getItem("proxyLink") + xor.encode(urlToProxy))
  } else {
